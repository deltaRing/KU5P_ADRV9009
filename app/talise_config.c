...
#include "../devices/talise/talise_types.h"
#include "talise_config.h"
#include "../devices/talise/talise_error.h"
#include "../devices/talise/talise_agc.h"
//#define ADI_ZYNQ_PLATFORM
...
taliseInit_t talInit =
{
    ...
    .tx = 
    {
        ...
        .tx2Atten_mdB = 5000,                            /* Initial Tx2 Attenuation */
    ...
    .jesd204Settings = 
    {
        ...
        .deframerA = 
        {
            ...
            /* FPGA TX lane n is wired directly to Talise deserializer lane n. */
            .deserializerLaneCrossbar = 0xE4,    /* identity: 3,2,1,0 fields = 3,2,1,0 */
        ...
        .serInvertLanePolarity = 0x1,            /* Serializer Lane PN inversion select. Default = 0. Where, bit[0] = 1 will invert lane [0], bit[1] = 1 will invert lane 1, etc. */
        /*
         * The Talise API applies the device-laminate default inversion as
         * ~(desInvertLanePolarity) & 0x0F.  Zero therefore programs all four
         * internal compensations.  The previous 0xF disabled them and the
         * received 5-bit ILAS values were complemented (3 became 28).
         */
        .desInvertLanePolarity = 0x0,
...
static taliseAgcCfg_t rxAgcCtrl =
{
    ...
    /* agcPeak */
    {
        ...
        2,          /*!<sets the 2nd update interval for the multiple time constant in AGC loop mode. Calculated as a multiple of  agcUnderRangeLowInterval鑱借伣, Default: 4 */
        ...
        3,          /*!<AGC APD peak detect lower threshold count. Default = 0x03, 8-bit register value where max = 0xFF, min = 0x00鑱� */
